          ...
          {merchCatalogue.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-56 rounded-xl bg-ink/5 dark:bg-canvas/5 flex items-center justify-center select-none mb-4 overflow-hidden group-hover:bg-ink/10 dark:group-hover:bg-canvas/10 transition-colors p-3">
